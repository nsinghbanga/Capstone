...
def main():
    ...
    while True:
        ...
        # Select ROI
        im2 = crop_image(image_frame, 200, 200, 200, 200)
        ...
        print(curr)
        cv2.putText(image_frame, curr, (100, 100), cv2.FONT_HERSHEY_COMPLEX, 2.0, (255, 255, 255), lineType=cv2.LINE_AA)

        # Display cropped image
        cv2.rectangle(image_frame, (200, 200), (400, 400), (255, 255, 00), 3)
